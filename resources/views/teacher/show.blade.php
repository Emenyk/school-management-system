                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="profile-info-inner">
                        <div class="profile-img">
                            @isset($teacher->image)
                            <img src="{{ asset('storage/images/teachers/'. $teacher->image)  }}">
                            @endisset
                            @empty($teacher->image)
                            <img alt="" class="" src="{{ asset('app/img/contact/1.jpg') }}">
                            @endempty
                        ...
                        <div class="profile-details-hr">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                    <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                        <p><b>Phone</b><br /> {{ $teacher->telephone }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                        <ul id="myTabedu1" class="tab-review-design">
                            ...
                            <li><a href="#Delete">Edit Teacher</a></li>
                        </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                    <div class="address-hr biography">
                                                        <p><b>Full Name</b><br /> {{ $teacher->name }}</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                    <div class="address-hr biography">
                                                        <p><b>Mobile</b><br /> {{ $teacher->telephone }}</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                    <div class="address-hr biography">
