                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                        <div class="panel-body custom-panel-jw">
                            ...
                            <img alt="logo" class="img-circle m-b" src="{{ asset('app/img/contact/1.jpg') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                        <div class="panel-body custom-panel-jw">
                            ...
                            <img alt="logo" class="img-circle m-b" src="{{ asset('app/img/contact/2.jpg') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                        <div class="panel-body custom-panel-jw">
                            ...
                            <img alt="logo" class="img-circle m-b" src="{{ asset('app/img/contact/3.jpg') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="hpanel hblue contact-panel contact-panel-cs res-tablet-mg-t-30 dk-res-t-pro-30">
                        <div class="panel-body custom-panel-jw">
                            ...
                            <img alt="logo" class="img-circle m-b" src="{{ asset('app/img/contact/4.jpg') }}">
